/**
 * El componente `Board` es un componente de React que representa un tablero de juego de Bingo con una lista de
 * jugadores, un cartón de bingo, una lista de números seleccionados, una lista de bolas extraídas y una bola actual.
 * @returns El componente `Board` devuelve una estructura JSX que representa el tablero del juego de Bingo.
 */
